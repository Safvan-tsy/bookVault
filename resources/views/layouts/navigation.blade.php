        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->isAdmin())
                        <x-nav-link :href="route('borrows.overdue')" :active="request()->routeIs('borrows.overdue')">
                            Overdue Books
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('borrows.overdue')" :active="request()->routeIs('borrows.overdue')">
                    Overdue Books
                </x-responsive-nav-link>
            @endif
        </div>
